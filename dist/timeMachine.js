...
// ]
const minutesTest = [
    ...timeMachine({ start: luxon_1.DateTime.utc(2019, 1, 5, 15, 33), end: luxon_1.DateTime.utc(2019, 1, 5, 15, 34), stepUnit: 'minutes', step: 1, lat: 52.3, lng: 4.9 }),
];
const minutesTestEnd = [
    ...timeMachine({ start: luxon_1.DateTime.utc(2019, 1, 5, 23, 28), end: luxon_1.DateTime.utc(2019, 1, 5, 23, 29), stepUnit: 'minutes', step: 1, lat: 52.3, lng: 4.9 }),
];
